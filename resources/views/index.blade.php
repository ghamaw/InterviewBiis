...
<body style="padding-bottom: 5rem">
    <nav class="navbar bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="/">
                <img src="{{ asset('logo.png') }}" alt="Biis Corp" width="200" height="40">
            </a>
        </div>
    </nav>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs fw-bold mb-1">
                                        Total Karyawan</div>
                                    <div class="h1 mb-0 fw-bold text-gray-800">{{ $dataPegawai->count() }}</div>
                                </div>
                                <div class="col-auto">
                    ...
                    <tbody>
                        @foreach ($dataPegawai as $index => $pegawai)
                            <tr>
                                ...
                                @endphp
                                <td><img src="{{ $photoUrl }}" alt="{{ $pegawai->name }}" width="50"
                                        height="50"></td>
                                <td>{{ $pegawai->name }}</td>
                                <td>{{ $pegawai->email }}</td>
                                <td>{{ $pegawai->roles }}</td>
                                <td>{{ $pegawai->start_date }}</td>
                                <td>
                                    @if ($documentUrl)
                                        <a href="{{ $documentUrl }}" target="_blank" class="btn">
    ...
    @include('components.modal-tambah-pegawai')
